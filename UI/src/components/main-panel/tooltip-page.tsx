...
import { useGetToolStateCmd, setToolStateCmd, useGetSelectedEdgeEntityCmd, lookAt } from 'hooks/cmd'
    ...
    return (
        <div style={{
            ...
            {toolState === ToolState.Choosing && (
                <div className='row' style={{ padding: '2em', justifyContent: 'center', width: '30em' }}>
